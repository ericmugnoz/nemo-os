...
_start:
    ...
    svc #0
    str x0, [sp, #-16]!
    adrp x0, var_menuArchivo
    add x0, x0, :lo12:var_menuArchivo
    ldr x1, [sp], #16
    str x1, [x0]
    adrp x0, str_1
    ...
    svc #0
    str x0, [sp, #-16]!
    adrp x0, var_menuSalir
    add x0, x0, :lo12:var_menuSalir
    ldr x1, [sp], #16
    str x1, [x0]
    adrp x0, str_2
    ...
    str x0, [sp, #-16]!
    adrp x0, var_btn
    add x0, x0, :lo12:var_btn
    ldr x1, [sp], #16
    str x1, [x0]
    mov x0, #0
    str x0, [sp, #-16]!
    adrp x0, var_clics
    add x0, x0, :lo12:var_clics
    ldr x1, [sp], #16
    str x1, [x0]
.Lrepeat_0:
    mov x8, #14
...
.align 3
var_root: .space 8
var_menuArchivo: .space 8
var_menuSalir: .space 8
var_btn: .space 8
var_clics: .space 8
var_ev: .space 8
